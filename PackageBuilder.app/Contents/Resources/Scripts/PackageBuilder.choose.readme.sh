#!/bin/sh
# PackageBuilder.choose.readme.sh - pick the readme document through a Choose panel
#
...
dbg_context "PackageBuilder.choose.readme.sh"

store_browsed_path "$README_ID" "$OMC_DLG_CHOOSE_FILE_PATH"
