#!/bin/sh
# PackageBuilder.choose.preinstall.sh - pick the preinstall script through a Choose panel
#
...
dbg_context "PackageBuilder.choose.preinstall.sh"

store_browsed_path "$PREINSTALL_ID" "$OMC_DLG_CHOOSE_FILE_PATH"
