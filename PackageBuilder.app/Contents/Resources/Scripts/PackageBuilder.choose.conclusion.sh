#!/bin/sh
# PackageBuilder.choose.conclusion.sh - pick the conclusion document through a Choose panel
#
...
dbg_context "PackageBuilder.choose.conclusion.sh"

store_browsed_path "$CONCLUSION_ID" "$OMC_DLG_CHOOSE_FILE_PATH"
